...
CFLAGS   = -fno-common -march=native -Os -pipe -fomit-frame-pointer $(ARCH_FLAG)
...
ORIG_SRCS = excelsior_reader.c
SRCS = $(ORIG_SRCS) 
OBJS = excelsior_reader.o
HDRS = 
TARGET = excelsior_reader
TARGET_NAME = excelsior_reader
...
pre-install-rb-default:
	$(ECHO) installing default excelsior_reader libraries
./.RUBYARCHDIR.time:
