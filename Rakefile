...
gem_spec = Gem::Specification.new do |gem_spec|
  ...
  gem_spec.summary = 'Ruby gem that uses C bindings to read CSV files superfast. I\'m totally serial!'
  gem_spec.description = 'Ruby gem that uses C bindings to read CSV files superfast. I\'m totally serial!'
